...
In the last post, we covered [Configuration Profile Version Control]({% post_url 2026-08-22-configuration-profile-version-control %}) and why exporting Intune configurations to JSON gives you an operational undo button.
